...
const Welcome = () => {
  return /* @__PURE__ */ jsx("div", { children: "Welcome" });
};
const About = () => {
  return /* @__PURE__ */ jsx("div", { children: "About" });
};
const NotFound = () => {
  return /* @__PURE__ */ jsx("div", { children: "NotFound" });
};
function App() {
  return /* @__PURE__ */ jsxs("div", { className: "App", children: [
    /* @__PURE__ */ jsxs("header", { className: "App-header", children: [
      /* @__PURE__ */ jsx("img", { src: logo, className: "App-logo", alt: "logo" }),
      /* @__PURE__ */ jsx("p", { children: "Welcome" })
    ] }),
    /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(Link, { to: "/about", children: "About" }) }),
    /* @__PURE__ */ jsxs(Routes, { children: [
      /* @__PURE__ */ jsx(Route, { path: "/", element: /* @__PURE__ */ jsx(Welcome, {}) }),
...
function render({ path }) {
  const html = ReactDOMServer.renderToString(
    /* @__PURE__ */ jsx(React.StrictMode, { children: /* @__PURE__ */ jsx(StaticRouter, { location: path, children: /* @__PURE__ */ jsx(App, {}) }) })
  );
  return { html };
}
export {
